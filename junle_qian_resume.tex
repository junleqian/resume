...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://junleqian.com/}{\Large Junle "Caleb" Qian}} & Email : \href{mailto:calebqian.uiuc@gmail.com}{calebqian.uiuc@gmail.com}\\
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: Python, JavaScript/TypeScript, C, C++, PostgreSQL, Java, Perl, Ruby}
    }
    \item{
          \textbf{Environments}{: AWS, Django, NodeJS, AngularJS, Ruby on Rails, Flask, RPM, Jenkins, Linux Internals}
    }
  \resumeSubHeadingListEnd
%-----------EXPERIENCE-----------------
\section{Experience}
